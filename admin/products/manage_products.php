                            ...
                            <tr>
                                <td>
                                    <div class="thumbnail-container">
                                        ...
                                        <?php else: ?>
                                            <div class="product-thumbnail no-image-placeholder">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <?php if ($product['IS_AVAILABLE'] == 1 || $product['IS_AVAILABLE'] === true || $product['IS_AVAILABLE'] === '1'): ?>
                                            <a href="toggle_product.php?id=<?php echo $product['ID']; ?>&action=disable" class="btn btn-sm btn-warning" title="Disable">
                                                <i class="fas fa-ban"></i> Disable
                                            </a>
                                        <?php else: ?>
                                            <a href="toggle_product.php?id=<?php echo $product['ID']; ?>&action=enable" class="btn btn-sm btn-success" title="Enable">
